...
export function start() {
    ...
    angular.module('testApp', [])
        .directive('appDirective', [function() {
            return {
                template: '<div ng-repeat="text in textLog">' +
        ...
        .controller('AppController', ['$scope', '$document', 'inputPromptText', 'appService', 'consoleTextService', appController.AppController]);
