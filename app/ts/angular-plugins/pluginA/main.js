...
define(["require", "exports", 'pluginA/Services/serviceA'], function(require, exports, __serviceA__) {
    ...
    function init() {
        angular.module('pluginA', []).factory('pluginAServiceA', ['consoleTextService', serviceA.PluginAServiceA]);
