...
define(["require", "exports"], function(require, exports) {
    function init() {
        angular.module('lazyModuleA', []).directive('lazyDirectiveA', [
            'appService',
            function (appService) {
                var t = appService.test(7);
                return {
        ...
        var setupLateDirective = function () {
            angular.module('lazyModuleA').directive('lazyDirectiveA2', [
                'lazyServiceB',
                function (lazyServiceB) {
                    var t = lazyServiceB.test(7);
                    return {
